...
#if !defined(Status_Reg_2_sts_reg__REMOVED) /* Check for removal by optimization */
...
*
* Summary:
*  Read the value of the Status_Reg_2_Status register
*
* Parameters:  
*  void
*
* Return: 
*  The value of the Status_Reg_2_Status register.
*
* Reentrant:
*  Yes
* 
