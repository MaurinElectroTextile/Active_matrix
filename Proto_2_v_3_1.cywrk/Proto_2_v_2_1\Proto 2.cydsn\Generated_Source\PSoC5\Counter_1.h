 ...
 **************************************/
#define Counter_1_INIT_PERIOD_VALUE       8u
#define Counter_1_INIT_COUNTER_VALUE      8u
#if (Counter_1_UsingFixedFunction)
#define Counter_1_INIT_INTERRUPTS_MASK    ((0u << Counter_1_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
#define Counter_1_INIT_COMPARE_VALUE      8u
#define Counter_1_INIT_INTERRUPTS_MASK ((0u << Counter_1_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
 ...
 *************************************/
    ...
    ********************************/
    ...
    #define Counter_1_STATUS               (* (reg8 *) Counter_1_CounterUDB_sSTSReg_nrstSts_stsreg__STATUS_REG )
    #define Counter_1_STATUS_PTR           (  (reg8 *) Counter_1_CounterUDB_sSTSReg_nrstSts_stsreg__STATUS_REG )
    #define Counter_1_STATUS_MASK          (* (reg8 *) Counter_1_CounterUDB_sSTSReg_nrstSts_stsreg__MASK_REG )
    #define Counter_1_STATUS_MASK_PTR      (  (reg8 *) Counter_1_CounterUDB_sSTSReg_nrstSts_stsreg__MASK_REG )
    #define Counter_1_STATUS_AUX_CTRL      (*(reg8 *) Counter_1_CounterUDB_sSTSReg_nrstSts_stsreg__STATUS_AUX_CTL_REG)
    #define Counter_1_STATUS_AUX_CTRL_PTR  ( (reg8 *) Counter_1_CounterUDB_sSTSReg_nrstSts_stsreg__STATUS_AUX_CTL_REG)
