...
/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_Start
********************************************************************************
* Summary:
...
void ADC_SAR_A_theACLK_Start(void) 
{
    ...
    ADC_SAR_A_theACLK_CLKEN |= ADC_SAR_A_theACLK_CLKEN_MASK;
}


/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_Stop
********************************************************************************
* Summary:
...
void ADC_SAR_A_theACLK_Stop(void) 
{
	...
	CYDEV_CHIP_REVISION_USED == CYDEV_CHIP_REVISION_5A_ES1))
/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_StopBlock
********************************************************************************
* Summary:
...
{
    if (ADC_SAR_A_theACLK_CLKEN & ADC_SAR_A_theACLK_CLKEN_MASK)
    {
        ...
        CLK_DIST_AMASK = ADC_SAR_A_theACLK_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = ADC_SAR_A_theACLK_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(ADC_SAR_A_theACLK_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(ADC_SAR_A_theACLK_DIV_PTR, oldDivider);
#endif
    }
}
#endif
...
/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_StandbyPower
********************************************************************************
* Summary:
...
void ADC_SAR_A_theACLK_StandbyPower(uint8 state) 
{
    if(state == 0)
    {
        ADC_SAR_A_theACLK_CLKSTBY &= ~ADC_SAR_A_theACLK_CLKSTBY_MASK;
    }
    else
    {
        ADC_SAR_A_theACLK_CLKSTBY |= ADC_SAR_A_theACLK_CLKSTBY_MASK;
...
/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_SetDividerRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_SAR_A_theACLK_SetDividerRegister(uint16 clkDivider, uint8 restart) 
{
    uint8 enabled;

    uint8 currSrc = ADC_SAR_A_theACLK_GetSourceRegister();
    uint16 oldDivider = ADC_SAR_A_theACLK_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = ADC_SAR_A_theACLK_CLKEN & ADC_SAR_A_theACLK_CLKEN_MASK;
        ...
        if (currSrc == CYCLK_SRC_SEL_CLK_SYNC_D && (oldDivider == 0 || clkDivider == 0))
        {
            ...
            if (oldDivider == 0 && clkDivider != 0)
            {
                ...
                CY_SET_REG16(ADC_SAR_A_theACLK_DIV_PTR, clkDivider);
                ADC_SAR_A_theACLK_MOD_SRC &= ~CYCLK_SSS;
            }
            else
            {
        ...
        else
        {
            ...
            ADC_SAR_A_theACLK_CLKEN |= enabled;
        }
    }
}
...
/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_GetDividerRegister
********************************************************************************
* Summary:
...
{
    return CY_GET_REG16(ADC_SAR_A_theACLK_DIV_PTR);
}


/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_SetModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_SAR_A_theACLK_SetModeRegister(uint8 clkMode) 
{
    ADC_SAR_A_theACLK_MOD_SRC |= clkMode & ADC_SAR_A_theACLK_MODE_MASK;
}


/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_ClearModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_SAR_A_theACLK_ClearModeRegister(uint8 clkMode) 
{
    ADC_SAR_A_theACLK_MOD_SRC &= ~clkMode | ~ADC_SAR_A_theACLK_MODE_MASK;
}
...
/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_GetModeRegister
********************************************************************************
* Summary:
...
{
    return ADC_SAR_A_theACLK_MOD_SRC & ADC_SAR_A_theACLK_MODE_MASK;
}


/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_SetSourceRegister
********************************************************************************
* Summary:
...
{
    uint16 currDiv = ADC_SAR_A_theACLK_GetDividerRegister();
    uint8 oldSrc = ADC_SAR_A_theACLK_GetSourceRegister();
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        ADC_SAR_A_theACLK_MOD_SRC |= CYCLK_SSS;
        ADC_SAR_A_theACLK_MOD_SRC =
            (ADC_SAR_A_theACLK_MOD_SRC & ~ADC_SAR_A_theACLK_SRC_SEL_MSK) | clkSource;
    }
...
/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_GetSourceRegister
********************************************************************************
* Summary:
...
{
    return ADC_SAR_A_theACLK_MOD_SRC & ADC_SAR_A_theACLK_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_SetPhaseRegister
********************************************************************************
* Summary:
...
{
    ADC_SAR_A_theACLK_PHASE = clkPhase & ADC_SAR_A_theACLK_PHASE_MASK;
}


/*******************************************************************************
* Function Name: ADC_SAR_A_theACLK_GetPhase
********************************************************************************
* Summary:
...
{
    return ADC_SAR_A_theACLK_PHASE & ADC_SAR_A_theACLK_PHASE_MASK;
}
