...
/* PSoC3 ES2 or early */
#define USBFS_PSOC3_ES2  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                                     (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_3A_ES2))

/* PSoC5 ES1 or early */
#define USBFS_PSOC5_ES1  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A) && \
                                     (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_5A_ES1))
/* PSoC3 ES3 or later */
#define USBFS_PSOC3_ES3  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                                     (CYDEV_CHIP_REVISION_USED > CYDEV_CHIP_REVISION_3A_ES2))

/* PSoC3 ES3 or early */
#define USBFS_PSOC3_UPTO_ES3 ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_3A) && \
                                         (CYDEV_CHIP_REVISION_USED <= CYDEV_CHIP_REVISION_3A_ES3))

/* PSoC5 ES2 or later */
#define USBFS_PSOC5_ES2  ((CYDEV_CHIP_MEMBER_USED == CYDEV_CHIP_MEMBER_5A) && \
                                     (CYDEV_CHIP_REVISION_USED > CYDEV_CHIP_REVISION_5A_ES1))
...
typedef struct _USBFS_EpCtlBlock 
{
    uint8  attrib;
    uint8  apiEpState;
    uint8  hwEpState;
...
typedef struct _USBFS_EpSettingsBlock 
{
    uint8  interface;
    uint8  altSetting;
    uint8  addr;
...
typedef struct _USBFS_BackupStruct
{
    uint8 enableState;
    uint8 mode;
...
void   USBFS_Resume(void) ;
    ...
    #define BTLDR_SIZEOF_WRITE_BUFFER    (64u)    /* EP 1 OUT */
    #define BTLDR_SIZEOF_READ_BUFFER     (64u)    /* EP 2 IN */
    #define BTLDR_MAX_PACKET_SIZE       BTLDR_SIZEOF_WRITE_BUFFER

#endif /* End CYDEV_BOOTLOADER_IO_COMP == USBFS */
...
#define USBFS_bEPHalt                    USBFS_epHalt
...
#define USBFS_EnableInt(a, b)            CyIntEnable(a)
...
#define USBFS_DIE_ID             CYDEV_FLSHID_CUST_TABLES_BASE
    ...
    #define USBFS_PM_AVAIL_CR_PTR    (  (reg8 *) CYREG_PM_AVAIL_CR6)
    #define USBFS_PM_AVAIL_CR_REG    (* (reg8 *) CYREG_PM_AVAIL_CR6)
#else  /* USBFS_PSOC3_ES3 || USBFS_PSOC5_ES2 */  
...
#if(USBFS_PSOC3_ES2 || USBFS_PSOC5_ES1)
    #define USBFS_PM_AVAIL_CR    USBFS_PM_AVAIL_CR_PTR
#endif /* End USBFS_PSOC3_ES2 || USBFS_PSOC5_ES1 */
...
#if (USBFS_MON_VBUS == 1u)
    #define USBFS_VBUS_DR        USBFS_VBUS_DR_PTR
    #define USBFS_VBUS_PS        USBFS_VBUS_PS_PTR
#endif /* End USBFS_MON_VBUS */
...
#define USBFS_CR1_BUS_ACTIVITY           (0x01u << USBFS_CR1_BUS_ACTIVITY_SHIFT)
...
#define USBFS_BUS_RST_COUNT              (0x03u)
