...
extern const uint8 CYCODE Filter_control[]; 
extern const uint8 CYCODE Filter_data_a[];
extern const uint8 CYCODE Filter_data_b[];
extern const uint8 CYCODE Filter_cfsm[];
extern const uint8 CYCODE Filter_acu[];
...
#define Filter_DA_RAM_SIZE            (0x200u)
#define Filter_DB_RAM_SIZE            (0x200u)
#define Filter_CSA_RAM_SIZE           (0x100u)
#define Filter_CSB_RAM_SIZE           (0x100u)
#define Filter_CFSM_RAM_SIZE          (0x100u)
#define Filter_ACU_RAM_SIZE           (0x040u)
